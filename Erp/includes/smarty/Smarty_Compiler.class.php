...
class Smarty_Compiler extends Smarty {
    ...
    function _compile_file($resource_name, $source_content, &$compiled_content)
    {
        ...
        $source_content = preg_replace($search.'e', "'"
                                       ...
                                       . "}'"
                                       , $source_content);
        // Memo from Sinri: This is original realization of Smarty 2.0. If warning comes out in higher version of PHP, use the resolution below to fix.
        ...
        // This is written by Sinri,  using preg_replace_callback to fix the Deprecation Issue of preg_replace modifier `/e`.
        }
