 ...
 * ---------------------------------------------
 * $Author: paulgao $
 * $Date: 2007-06-10 00:52:06 +0800 (星期日, 10 六月 2007) $
 * $Id: cls_ecshop.php 9138 2007-06-09 16:52:06Z paulgao $
*/
...
class ECS
{
    ...
    function url()
    {
        $curr = strpos($_SERVER['PHP_SELF'], 'admin/') !== false ?
                preg_replace('/(.*)(admin)(\/?)(.)*/i', '\1', dirname($_SERVER['PHP_SELF'])) :
