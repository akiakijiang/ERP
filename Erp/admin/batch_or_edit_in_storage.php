...
$sql = "
		SELECT
	        ...
	        og.goods_name, og.goods_number, og.customized, og.goods_id, og.style_id, g.is_maintain_warranty,g.is_maintain_batch_sn, gs.internal_sku, if(gs.barcode is NULL or gs.barcode = '',g.barcode,gs.barcode) as barcode,
...
$url = "batch_or_edit_in_storage.php?batch_order_id={$batch_order_id}";
...
$smarty->assign('info', $info);
$smarty->display ( 'oukooext/batch_or_edit_in_storage.htm' );
