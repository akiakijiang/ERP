 ...
 * $Id: attribute.php 8272 2007-04-19 10:11:35Z paulgao $
*/
...
if ($_REQUEST['act'] == 'list')
{
    ...
    $smarty->assign('action_link',      array('href' => 'attribute.php?act=add', 'text' => $_LANG['10_attribute_add']));
...
elseif ($_REQUEST['act'] == 'insert' || $_REQUEST['act'] == 'update')
{
    ...
    $attr = array(
        ...
        'attr_type'     => isset($_POST['attr_type']) ? '1' : '0',
    );
    /* 入库、记录日志、提示信息 */
    if ($is_insert)
    {
        ...
        $links = array(
            array('text' => $_LANG['add_next'], 'href' => '?act=add'),
    ...
    else
    {
        ...
        $links = array(
            array('text' => $_LANG['back_list'], 'href' => '?act=list&cat_id='.$_POST['cat_id'].''),
        );
...
function get_attrlist()
{
    ...
    {
        $row[$key]['attr_select_desc'] = $GLOBALS['_LANG']['value_attr_select'][$val['attr_select']];
