...
require_once(ROOT_PATH . "admin/includes/rpc/sso/OKLoginUser.php");
require_once(ROOT_PATH . "admin/includes/rpc/sso/UniUserServiceClient.php");
...
class UniUserServiceClient{
  ...
  function getUserAppPriority($userId, $applicationKey){
    $values = array($userId,$applicationKey);
    $types = array("string","string");
    return CallRemoteService($this->context, "universal.user.UniUserService", "getUserAppPriority", $values, $types);
  }
}
?>