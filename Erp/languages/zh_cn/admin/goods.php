 ...
 * $Id: goods.php 8272 2007-04-19 10:11:35Z paulgao $
*/
...
$_LANG['lab_is_gift'] = '是赠品：';
$_LANG['lab_can_handsel'] = '参与送赠品活动：';
...
$_LANG['can_handsel'] = '在计算订单金额是否可以送赠品时，将该商品价格计算在内。';
...
$_LANG['invalid_cycle_img'] = '轮播图片格式不正确！';
...
$_LANG['cycle_img_too_big'] = '轮播图片文件太大了（最大值：%s），无法上传。';
...
$_LANG['js_languages']['goods_cat_not_null'] = '商品分类不能不选。';
