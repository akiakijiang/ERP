...
header('Location: ./html/image.php?filetype=PNG&dpi=72&scale=3&rotation=0&font_family=Arial.ttf&font_size=16&text='.urlencode($sinri_content).'&thickness=60&start=C&code=BCGcode128');
