 ...
 * 进行修改、使用和再发布。
 * ============================================================================
 * @author:     Xu Chaoqian <xuchaqian@163.com>
 * @version:    2.x
 * ---------------------------------------------
 * $Author: xcq $
...
class sms
{
     ...
     * @var     array       $api_urls
     */
    var $api_urls   = array('register'          =>      'http://api.ecshop.com/register.php',
                            'auth'              =>      'http://api.ecshop.com/user_auth.php',
                            'send'              =>      'http://api.ecshop.com/send_sms.php',
                            'charge'            =>      'http://api.ecshop.com/charge.php?act=charge_form',
                            'balance'           =>      'http://api.ecshop.com/get_balance.php',
                            'send_history'      =>      'http://api.ecshop.com/send_history.php',
                            'charge_history'    =>      'http://api.ecshop.com/charge_history.php');
    /**
     * 存放MYSQL对象
     *
     * @access  private
    ...
    {
        $sql = 'UPDATE ' . $this->ecs->table('shop_config') . " SET `value` = '" . time() . "' WHERE `code` = 'sms_last_request'";
        $result = $this->db->query($sql);
