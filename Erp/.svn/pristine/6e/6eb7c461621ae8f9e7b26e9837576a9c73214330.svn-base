 ...
 * ---------------------------------------------
 * $Author: scottye $
 * $Date: 2007-05-10 10:52:52 +0800 (星期四, 10 五月 2007) $
 * $Id: order.php 8545 2007-05-10 02:52:52Z scottye $
 */
...
$_LANG['label_country_province']= '国家/省份：';
$_LANG['label_city_district'] = '城市/区域：';
$_LANG['name'] = '名称';
$_LANG['desc'] = '描述';
...
$_LANG['js_languages']['pls_select_country'] = '请选择国家';
$_LANG['js_languages']['pls_select_province'] = '请选择省份';
$_LANG['js_languages']['pls_select_city'] = '请选择城市';
$_LANG['js_languages']['pls_select_district'] = '请选择区域';
