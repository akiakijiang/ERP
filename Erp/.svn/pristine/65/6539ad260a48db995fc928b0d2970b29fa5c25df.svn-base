...
/* 取得当前ecshop所在的根目录 */
define('ROOT_PATH', str_replace('includes/master_init.php', '', str_replace('\\', '/', __FILE__)));
...
require(ROOT_PATH . 'data/master_config.php');
...
if ((DEBUG_MODE & 1) == 1 || $_REQUEST['debug'] == 'OUKOO_DEBUG_PASS')
{
