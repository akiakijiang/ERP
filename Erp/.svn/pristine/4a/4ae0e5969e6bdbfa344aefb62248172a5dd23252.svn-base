 ...
 * $Id: mail_template.php 8272 2007-04-19 10:11:35Z paulgao $
*/
...
$_LANG['ems_weekend_inform'] = 'EMS_COD周末不取件模板';
$_LANG['goods_inform'] = '到货通知模板';
$_LANG['shortage_inform'] = '缺货通知模板';
$_LANG['pricecut_inform'] = '降价提醒模板';
$_LANG['comment'] = '订单评价模板';
$_LANG['notify_not_pay'] = '订单未付款模板';
