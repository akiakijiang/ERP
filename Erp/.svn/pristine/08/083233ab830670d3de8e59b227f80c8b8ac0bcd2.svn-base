...
class Client{
	 ...
	 * 序列号,请通过亿美销售人员获取
	 */
	//var $serialNumber = '3SDK-VBT-0130-MCSSS';
	var $serialNumber;
	/**
	 * 密码,请通过亿美销售人员获取
	 */
	 ...
	 * @param string $sendTime		定时发送时间，格式为 yyyymmddHHiiss, 即为 年年年年月月日日时时分分秒秒 ,如果不需要定时发送，请为'' (默认)
	 *  
