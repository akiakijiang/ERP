 ...
 * ---------------------------------------------
 * $Author: paulgao $
 * $Date: 2007-03-23 20:09:00 +0800 (星期五, 23 三月 2007) $
 * $Id: shop_config.php 7565 2007-03-23 12:09:00Z paulgao $
 */
...
$_LANG['cfg_name']['shop_name'] = '默认商店名称';
$_LANG['cfg_name']['shop_name_8'] = 'OPPO订单显示商店名称';
...
$_LANG['cfg_name']['smtp_host'] = '邮件服务器地址';
$_LANG['cfg_name']['smtp_port'] = '服务器端口';
$_LANG['cfg_name']['smtp_user'] = '邮件发送帐号';
$_LANG['cfg_name']['smtp_pass'] = '帐号密码';
$_LANG['cfg_name']['smtp_mail'] = '默认邮件回复地址';
$_LANG['cfg_name']['smtp_mail_8'] = 'OPPO订单邮件回复地址';
$_LANG['cfg_name']['mail_charset'] = '邮件编码';
$_LANG['cfg_name']['smtp_debug'] = '测试参数';
$_LANG['cfg_name']['smtp_debug_path'] = '测试邮件目录';
...
$_LANG['cfg_name']['enable_captcha'] = '管理中心登录是否启用验证码';
...
$_LANG['cfg_name']['comment_captcha'] = '用户留言是否启用验证码';
...
$_LANG['cfg_name']['sms_cod_message'] = 'COD短信确认';
$_LANG['cfg_name']['shop_slagon'] = '默认 Flash 宣传图片';
...
$_LANG['cfg_name']['service_tips'] = '售后对应的各种说明';
$_LANG['cfg_name']['one_step_delivery'] = '一步式发货';
...
$_LANG['cfg_desc']['goods_name_length'] = '设定页面中显示的商品名称的长度，请注意1个汉字等于3个字符。';
...
$_LANG['cfg_range']['smtp_debug']['debug'] = '测试';
$_LANG['cfg_range']['smtp_debug']['formal'] = '正式';
$_LANG['cfg_range']['mail_config']['test'] = '拦截';
$_LANG['cfg_range']['mail_config']['formal'] = '正常发送';
$_LANG['cfg_range']['mail_log']['no'] = '不记录';
$_LANG['cfg_range']['mail_log']['yes'] = '记录';
$_LANG['cfg_range']['comment_check']['0'] = '不需要审核';
$_LANG['cfg_range']['comment_check']['1'] = '需要审核';
$_LANG['cfg_range']['enable_captcha']['0'] = '禁用';
$_LANG['cfg_range']['enable_captcha']['1'] = '启用';
$_LANG['cfg_range']['comment_captcha']['0'] = '禁用';
$_LANG['cfg_range']['enable_gzip']['1'] = '启用';
$_LANG['cfg_range']['enable_gzip']['0'] = '禁用';
$_LANG['cfg_range']['comment_captcha']['1'] = '启用';
...
$_LANG['cfg_range']['sms_cod_message']['1'] = '发短信';
$_LANG['cfg_range']['sms_cod_message']['0'] = '不发短信';
$_LANG['cfg_range']['one_step_delivery']['0'] = '不开启';
$_LANG['cfg_range']['one_step_delivery']['1'] = '开启';
$_LANG['cfg_range']['inventory_summary_list_enabled']['0'] = '不开启';
$_LANG['cfg_range']['inventory_summary_list_enabled']['1'] = '开启';

// 呼叫中心

// 屏蔽号码开关
$_LANG['cfg_range']['callcenter_switch']['off'] = '不开启';
$_LANG['cfg_range']['callcenter_switch']['on'] = '开启';
