 ...
 */
 ...
 if ('create_item' == $act) {
 	...
 	$obj_data->fchr_warehouse_id = $_POST['fchr_warehouse_id'];
 	$obj_data->ret_facility_id_dt = $_POST['ret_facility_id_dt'];
 	$obj_data->ret_goods_id = $_POST['ret_goods_id'];
	$obj_data->ret_style_id = $_POST['ret_style_id'];
	$obj_data->goods_name = $_POST['goods_name'];
	$obj_data->arrive_time = $_POST['arrive_time_dc'];
   ...
   sys_msg("{$sys_message}",0,array(array('href'=>'./supplier_dt_goods_request.php')),true); 
 } 
...
// $smarty->assign('category_list',getCategory());
 ...
 $smarty->display('supplier_return/supplier_dt_goods_request.htm');
 QLog::log('out');
