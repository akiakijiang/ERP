 ...
 * $Id: bonus.php 8272 2007-04-19 10:11:35Z paulgao $
*/
/* 红包类型字段信息 */
...
$_LANG['order_money_notic'] = '当按订单金额发放此类型的红包时,订单金额应在订单下限与订单上限之间';
$_LANG['type_money_notic'] = '此类型的红包可以抵销的金额';
$_LANG['send_startdate_notic'] = '只有当前时间介于起始日期和截止日期之间时，此类型的红包才可以发放或使用';
...
$_LANG['success_send_mail'] = '成功发送了 %d 封邮件';
$_LANG['send_continue'] = '继续发送下一批红包';
