...
require_once(ROOT_PATH . 'admin/includes/freight/cls_inter_freight_sheet.php');
require_once(ROOT_PATH . 'admin/includes/freight/cls_ems_freight_sheet.php');
require_once(ROOT_PATH . 'admin/includes/freight/cls_shunfeng_freight_sheet.php');
require_once(ROOT_PATH . 'admin/includes/freight/cls_yuantong_freight_sheet.php');
require_once(ROOT_PATH . 'admin/includes/freight/cls_zhaijisong_freight_sheet.php');
require_once(ROOT_PATH . 'admin/includes/freight/cls_shentong_freight_sheet.php');
require_once(ROOT_PATH . 'admin/includes/freight/cls_huitong_freight_sheet.php');
require_once(ROOT_PATH . 'admin/includes/freight/cls_zhongtong_freight_sheet.php');
require_once(ROOT_PATH . 'admin/includes/freight/cls_yunda_freight_sheet.php');
require_once(ROOT_PATH . 'admin/includes/freight/cls_xiaobao_freight_sheet.php');
require_once(ROOT_PATH . 'admin/includes/freight/cls_factorage_sheet.php');
require_once(ROOT_PATH . 'admin/includes/freight/cls_ems_factorage_sheet.php');
require_once(ROOT_PATH . 'admin/includes/freight/cls_zhaijisong_factorage_sheet.php');
require_once(ROOT_PATH . 'admin/includes/freight/cls_eyoubao_freight_sheet.php');
require_once(ROOT_PATH . 'admin/includes/freight/cls_emseco_freight_sheet.php');
require_once(ROOT_PATH . 'admin/includes/freight/cls_shunfengluyun_freight_sheet.php');
require_once(ROOT_PATH . 'admin/includes/freight/cls_DHL_freight_sheet.php');
require_once(ROOT_PATH . 'admin/includes/freight/cls_FEDEX_freight_sheet.php');
require_once(ROOT_PATH . 'admin/includes/freight/cls_UPS_freight_sheet.php');
require_once(ROOT_PATH . 'admin/includes/freight/cls_InterEMS_freight_sheet.php');
require_once(ROOT_PATH . 'admin/includes/freight/cls_InterYouzheng_freight_sheet.php');
require_once(ROOT_PATH . 'admin/includes/freight/cls_tiantian_freight_sheet.php');
require_once(ROOT_PATH . 'admin/includes/freight/cls_yousucod_freight_sheet.php');
