 ...
 * $Id: tenpay.php 8653 2007-05-17 05:33:17Z paulgao $
 */
...
class tenpay
{
    ...
    function get_code($order, $payment)
    {
        ...
        /* 返回的路径 */
        $return_url =  RETURNURL.'?code=tenpay';//('http://localhost/ouku_return.php?code=tenpay');
        ...
        $button  = '<form style="text-align:center;padding:0px;margin:0px;" action="https://www.tenpay.com/cgi-bin/v1.0/vast_pay_gate.cgi" target="_blank">';
        ...
        $button  .= '<input class="tenpayButton" type="submit" value="' .$GLOBALS['_LANG']['pay_button']. '" /></form>';
        
        global $db, $ecs;
        $ouku_request = $db->escape_string($button);
